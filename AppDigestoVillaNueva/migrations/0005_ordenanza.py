...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('AppDigestoVillaNueva', '0004_alter_documento_fecha_creacion'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo_pdf', models.FileField(blank=True, null=True, upload_to=AppDigestoVillaNueva.models.upload_to_ordenanza, validators=[django.core.validators.FileExtensionValidator(['pdf'], message='ERROR, el archivo tiene que estar en formato PDF.')])),
            ],
